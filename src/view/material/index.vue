                                    ...
                                    <div style="background-color: #fff;">
                                        <div style="padding: 10px">
                                            <div class="sheet-cell-column2">
                                                ...
                                                <div style="height: 25px; display: flex; justify-content: space-between; align-items: end; padding-top: 10px">
                                                    <div style="font-size: 0.7rem">种类: {{sheetItem['materialTypes']}}
                                                    </div>
                                                    <div style="font-size: 0.7rem">预警: {{sheetItem['materialTypes'] -
                                            ...
                                            <div>
                                                ...
                                                <div style="padding-top: 8px">
                                                    <div style="position: relative">
                                                        ...
                                                        <span v-show="getProductCurrentPercent(sheetItem)>100" style="position:absolute; right: 10px; top: 0; line-height: 26px; color: white">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div style="display: flex; justify-content: space-between">
                                            ...
                                            <div style="font-size: 0.7rem">预警: {{props.row['materialTypes'] -
                            ...
                            <template #default="props">
                                <div>
                                    ...
                                    <div style="position: relative">
                                        ...
                                        <span v-show="getProductCurrentPercent(props.row)>100" style="position:absolute; right: 10px; top: 0; line-height: 26px; color: white">
